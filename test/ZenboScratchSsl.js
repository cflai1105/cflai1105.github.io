...
{  
   ...
   ext.stop_sending_commands_to_target = function () {
    ...
    ext.recordAudio = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=recordAudio' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.recordVideo = function (p1, p2, p3 ) {
        ...
        console.log(p3);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=recordVideo' + '&p1=' + p1 + '&p2=' + p2 + '&p3=' + p3 ,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
   ...
   ext.startWheelLight = function (p1, p2, p3, p4) {
        ...
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=startWheelLight' + '&p1=' + p1 + '&p2=' + p2 + '&p3=' + p3 + '&p4=' + p4 ,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
   ...
   ext.stopWheelLight = function (p1) {
        ...
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=stopWheelLight' + '&p1=' + p1 ,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
