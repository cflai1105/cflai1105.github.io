   ...
   ext.stopWheelLight = function (p1) {
    ...
    var TRANSLATIONS = {
        us: {
	        ...
	        head_direction: ["top", "bottom"],
            head_degree: ["0", "10", "30", "45"],
      ...
      startWheelLightEffect: ["static", "breath rainbow", "color cycle", "forward comet", "backward comet", "forward flash dash", "backward flash dash", "glowing yoyo", "forward moving flash", "backward moving flash", "forward rainbow", "backward rainbow", "forward rainbow wave", "backward rainbow wave", "starry night", "strobing", "wave"],
	...
	tw: {
      ...
      startWheelLightEffect: ["恆亮","BreathRainbow","ColorCycle","ForwardComet","BackwardComet","ForwardFlashDash","backwardFlashDash","GlowingYoYo","ForwardMovingFlash","BackwardMovingFlash","ForwardRainbow","BackwardRainbow","ForwardRainbowWave","BackwardRainbowWave","StarryNight","Strobing","Wave"],
