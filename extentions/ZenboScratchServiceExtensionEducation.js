(function (ext) {
    ...
    ext._stop = function () {   
        ...
        console.log(ip);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=stopAll',
            dataType: 'text',
            crossDomain: true,
    ...
    var getSentencesRecursion = function(flagIndex) {
		...
		$.ajax({
			type: 'GET',
			url: 'https://' + ip + port + '/?extension=education' + '&name=Get_sentences',
			dataType: 'text',
			crossDomain: true,
			success: function (data) {
...
{  
    ...
    ext.Head_movement = function (p1, p2, callback) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Head_movement' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Body_movement = function (p1, p2, p3, callback) {
        ...
        console.log(p3);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Body_movement' + '&p1=' + p1 + '&p2=' + p2 + '&p3=' + p3,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Body_turn = function (p1, p2, callback) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Body_turn' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Remote_control_body = function (p1){
        ...
        console.log(p1);
           ...
           $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Remote_control_body' + '&p1=' + p1,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
	...
	console.log(ip);
	$.ajax({
	    url: 'https://' + ip + port + '/?extension=education' + '&name=Remote_control_body' + '&p1=' + 'stop',
	    dataType: 'text',
 	    crossDomain: true,
 	    success: function (data) {
	    console.log("success handler");
	    ...
	    console.log(ip);
            $.ajax({
                url: 'https://' + ip + port + '/?extension=education' + '&name=Stop_moving',
                dataType: 'text',
                crossDomain: true,
                success: function (data) {
                console.log("success handler");
    ...
    ext.Action = function (callback){
        ...
        console.log(p1);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Action' + '&p1=' + p1,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Facial = function (p1, callback) {
        ...
        console.log(p1);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Facial' + '&p1=' + p1,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.TTS = function (p1, callback) {
        ...
        console.log(p1);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=TTS' + '&p1=' + p1,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.TTS_editor = function (p1, callback) {
        ...
        console.log(p1);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=TTS_editor' + '&p1=' + p1,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Cancel_actionset = function (callback){
        ...
        console.log(ip);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Cancel_actionset',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Adjust_stream_volume = function (p1, p2, callback) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Adjust_stream_volume' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Add_and_update_sentence = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Add_and_update_sentence' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
            console.log("success handler");
    ...
    ext.Delete_instance = function (callback){
        ...
        console.log(ip);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Delete_instance',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Speak_and_listen = function (){
        ...
        console.log(ip);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Speak_and_listen',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
    ...
    ext.Adjust_tts_and_speed = function (p1, p2, callback) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=Adjust_tts_and_speed' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.playVideosInYoutube = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=playVideosInYoutube' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.displayUrlPictures = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=displayUrlPictures' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.playUrlMusic = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=playUrlMusic' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.hideFace = function () {
        ...
        console.log(ip);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=hideFace',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.openDriveVideoUrl = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=openDriveVideoUrl' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.openDriveAudioUrl = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=openDriveAudioUrl' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.openDrivePictureUrl = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=openDrivePictureUrl' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.openDriveDocumentUrl = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=education' + '&name=openDriveDocumentUrl' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
   ...
   ext.stop_sending_commands_to_target = function () {
    ...
    ext.recordAudio = function (p1, p2) {
        ...
        console.log(p2);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=advance' + '&name=recordAudio' + '&p1=' + p1 + '&p2=' + p2,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.recordVideo = function (p1, p2, p3 ) {
        ...
        console.log(p3);
        $.ajax({
            url: 'https://' + ip + port + '/?extension=advance' + '&name=recordVideo' + '&p1=' + p1 + '&p2=' + p2 + '&p3=' + p3 ,
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    //   1 - explicit 'lang' parameter in the url (e.g: https://scratchx.org/?url=https://zenboscratchservice.github.io/extentions/ZenboScratchServiceExtensionEducation.js&lang=en#scratch)
